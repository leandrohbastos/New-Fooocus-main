    ...
    with gr.Tab("Vídeo"):
        with gr.Row():
            with gr.Column():
                ...
                video_motion_type = gr.Radio(
                    choices=["pan", "zoom", "interpolation"],
                    value="pan",
                    label="Tipo de Movimento"
                )
                video_motion_params = gr.JSON(
                    label="Parâmetros de Movimento",
                    value={
                        "direction": "right",
                        "speed": 0.1
                    }
                )
                video_generate_btn = gr.Button("Gerar Vídeo")
        ...
        def generate_video(
            ...
            try:
                ...
                if not generator.load_models():
                    return None, "Erro ao carregar modelos"
                ...
                if success:
                    return output_path, "Vídeo gerado com sucesso!"
                else:
                    return None, "Erro ao gerar vídeo"
        ...
        video_generate_btn.click(
            ...
            outputs=[video_output, gr.Textbox(label="Status")]
        )

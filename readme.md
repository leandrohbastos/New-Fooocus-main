# Fooocus - Versão Hiper-Realista

<div align=center>
<img src="https://github.com/lllyasviel/Fooocus/assets/19834515/483fb86d-c9a2-4c20-997c-46dafc124f25">
</div>

Fooocus é um software de geração de imagens e vídeos hiper-realistas baseado em [Gradio](https://www.gradio.app/) <a href='https://github.com/gradio-app/gradio'><img src='https://img.shields.io/github/stars/gradio-app/gradio'></a>.

Esta versão do Fooocus foi especializada para geração de conteúdo hiper-realista, com foco em:
- Imagens fotográficas de alta qualidade
- Retratos realistas
- Cenas urbanas e naturais
- Fotografia de produtos
- Arquitetura
- Moda
- Geração de vídeos curtos (até 30 segundos)

## Características Principais

### Geração de Imagens
- Foco exclusivo em estilo hiper-realista
- Modelo base: Juggernaut XL
- Presets otimizados para diferentes tipos de fotografia
- Suporte a ControlNet para maior controle
- Interface simplificada focada em resultados realistas

### Geração de Vídeo
- Suporte a vídeos de até 30 segundos
- Múltiplos tipos de movimento:
  - Pan (horizontal/vertical)
  - Zoom (in/out)
  - Interpolação suave entre frames
- Otimizado para rodar no Google Colab gratuito
- Exportação em MP4 (resolução mínima: 512x512)

## Requisitos Mínimos

| Sistema Operacional | GPU | VRAM Mínima | RAM Mínima | Swap |
|---------------------|-----|-------------|------------|------|
| Windows/Linux | NVIDIA RTX 4XXX | 4GB | 8GB | Necessário |
| Windows/Linux | NVIDIA RTX 3XXX | 4GB | 8GB | Necessário |
| Windows/Linux | NVIDIA RTX 2XXX | 4GB | 8GB | Necessário |
| Windows/Linux | NVIDIA GTX 1XXX | 8GB | 8GB | Necessário |
| Windows | AMD GPU | 8GB | 8GB | Necessário |
| Linux | AMD GPU | 8GB | 8GB | Necessário |
| Mac | M1/M2 MPS | Compartilhada | Compartilhada | Compartilhada |

## Instalação

### Windows
1. Baixe o arquivo mais recente da [página de releases](https://github.com/lllyasviel/Fooocus/releases)
2. Extraia o arquivo
3. Execute `run.bat`

### Google Colab
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/leandrohbastos/New-Fooocus-main/blob/main/fooocus_hyper_realistic_colab.ipynb)
...
### Geração de Imagens
1. Selecione um dos presets realistas disponíveis
2. Digite seu prompt descrevendo a imagem desejada
3. Ajuste os parâmetros básicos se necessário
4. Clique em "Gerar"

### Geração de Vídeo
1. Vá para a aba "Vídeo"
2. Digite seu prompt descrevendo o vídeo desejado
3. Ajuste a duração (1-30 segundos)
4. Selecione o tipo de movimento
5. Ajuste os parâmetros de movimento se necessário
6. Clique em "Gerar Vídeo"

## Presets Disponíveis

- **Hyper Realistic**: Geral, fotografia realista
- **Studio Portrait**: Retratos profissionais
- **Cinematic**: Estilo cinematográfico
- **Urban Scene**: Cenas urbanas e street photography
- **Nature Photography**: Paisagens e natureza
- **Product Photography**: Fotografia de produtos
- **Architectural**: Arquitetura e edificações
- **Fashion Photography**: Moda e editorial

## Otimização para Colab

Para melhor performance no Google Colab gratuito:
1. Use o modo "low VRAM" quando disponível
2. Mantenha a resolução em 512x512 ou 768x768
3. Use o preset "Hyper Realistic" como base
4. Para vídeos, mantenha a duração em 10-15 segundos

## Customização

O arquivo `config.txt` permite ajustar:
...
Para problemas e sugestões, abra uma issue no GitHub.

## Créditos

- Baseado no projeto original Fooocus
- Modelo Juggernaut XL
- AnimateDiff para geração de vídeo
...
| Colab | Info
| --- | --- |
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/leandrohbastos/New-Fooocus-main/blob/main/fooocus_hyper_realistic_colab.ipynb) | Fooocus Official
